...
/**
 * An {@link Anomaly} is an extended identifier. It is represented by an {@link Identity} identifier with IdentityType =
 * other
 * ,other-type = extended and with an administrative domain.
 * 
 * @author Marcel Reichenbach
 */
public class Anomaly extends IdentifierWithAd implements ExtendedIdentifier {
	...
	public boolean equals(Object other) {
		...
		Anomaly otherItem = (Anomaly) other;
