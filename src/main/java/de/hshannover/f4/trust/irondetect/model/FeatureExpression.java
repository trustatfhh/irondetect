...
public class FeatureExpression extends Evaluable {
	...
	public FeatureExpression() {
		this.featureValPair =
				new Pair<String, Pair<ComparisonOperator, String>>(null, new Pair<ComparisonOperator, String>(null,
						null));
		this.valid = true;
		this.counter = false;
		this.isEvaluated = false;
	...
	public String toString() {
		StringBuilder sigStr = new StringBuilder("featureValPair=");
		sigStr.append(featureValPair.getFirstElement());
		sigStr.append(' ');
		sigStr.append(featureValPair.getSecondElement().getFirstElement());
		sigStr.append(' ');
		sigStr.append(featureValPair.getSecondElement().getSecondElement());
		return "FeatureExpression [" + sigStr.toString() + "]";
	}
}
