...
public class Configuration {
	...
	public static final String KEY_IFMAP_BASIC_DEVICESUBSCRIBER_USERNAME =
			"irondetect.ifmap.basic.devicesubscriber.username";
	public static final String DEFAULT_VALUE_IFMAP_BASIC_DEVICESUBSCRIBER_USERNAME = "irondetect";
	public static final String KEY_IFMAP_BASIC_DEVICESUBSCRIBER_PASSWORD =
			"irondetect.ifmap.basic.devicesubscriber.password";
	public static final String DEFAULT_VALUE_IFMAP_BASIC_DEVICESUBSCRIBER_PASSWORD = "irondetect";

	public static final String KEY_IFMAP_BASIC_POLICYPUBLISHER_USERNAME =
			"irondetect.ifmap.basic.policypublisher.username";
	public static final String DEFAULT_VALUE_IFMAP_BASIC_POLICYPUBLISHER_USERNAME = "irondetect-publisher";
	public static final String KEY_IFMAP_BASIC_POLICYPUBLISHER_PASSWORD =
			"irondetect.ifmap.basic.policypublisher.password";
	...
	public static final String KEY_SELF_PUBLISH_ENABLED = "irondetect.publisher.selfpublish.enabled";
	public static final boolean DEFAULT_VALUE_SELF_PUBLISH_ENABLED = true;
	public static final String KEY_SELF_PUBLISH_DEVICE = "irondetect.publisher.selfpublish.device";
	public static final String DEFAULT_VALUE_SELF_PUBLISH_DEVICE = "irondetect-device";
}
