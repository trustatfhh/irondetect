...
import de.fhhannover.inform.trust.irondetect.util.event.TrainingData;
import de.fhhannover.inform.trust.irondetect.util.event.TrainingDataLoadedEvent;
...
public class FeatureBaseImpl implements FeatureBase {
	...
	/* (non-Javadoc)
	 * @see de.fhhannover.inform.trust.irondetect.repository.FeatureBaseInterface#addNewFeatures(java.util.ArrayList)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.fhhannover.inform.trust.irondetect.repository.FeatureBaseInterface#getFeaturesByContext(de.fhhannover.inform.trust.irondetect.model.ContextParameter)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.fhhannover.inform.trust.irondetect.repository.FeatureBase#addEventReceiver(de.fhhannover.inform.trust.irondetect.util.EventReceiver)
	 */
	@Override
