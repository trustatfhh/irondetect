package de.fhhannover.inform.trust.irondetect.util.event;
...
public class ResultUpdateEvent extends Event {

	private ResultObject payload;

	public ResultUpdateEvent(ResultObject payload) {
		super(EventType.RESULT_UPDATE);
		this.payload = payload;
	}

	public void setPayload(ResultObject payload) {
		this.payload = payload;
	}

	public ResultObject getPayload() {
		return this.payload;
	}
